...
const Carousel = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & CarouselProps>(
  ({ orientation = "horizontal", opts, setApi, plugins, className, children, dir, ...props }, ref) => {
    const resolvedDirection = (dir ?? opts?.direction ?? "ltr") as "ltr" | "rtl";
...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div ref={carouselRef} className="overflow-hidden -m-4 p-4" dir={dir}>
        <div
          ref={ref}
          className={cn(
            "flex",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "overflow-visible",
          isHorizontal ? (isRtl ? "pr-4" : "pl-4") : "pt-4",
          className,
        )}
        {...props}
      />
